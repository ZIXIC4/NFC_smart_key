...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BUSY_Pin USB_VBUS_Pin */
  GPIO_InitStruct.Pin = BUSY_Pin|USB_VBUS_Pin;
  ...
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RESET_N_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : REQ_Pin LED1_Pin LED2_Pin LED3_Pin */
  GPIO_InitStruct.Pin = REQ_Pin|LED1_Pin|LED2_Pin|LED3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : SEN_EN_Pin */
  GPIO_InitStruct.Pin = SEN_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SEN_EN_GPIO_Port, &GPIO_InitStruct);
